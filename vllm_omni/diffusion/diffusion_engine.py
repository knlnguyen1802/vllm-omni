...
class DiffusionEngine:
    ...
    def __init__(self, od_config: OmniDiffusionConfig):
        ...
        # Initialize executor - this handles all worker and scheduler initialization
    ...
    def step(self, requests: list[OmniDiffusionRequest]):
        try:
            ...
            output = self.executor.add_requests(requests)
            if output.error:
    ...
    def _dummy_run(self):
        ...
        self.executor.add_requests(requests)
    ...
    def close(self) -> None:
        """Close the engine and shutdown the executor."""
        self.executor.shutdown()

    def abort(self, request_id: str | Iterable[str]) -> None:
        """Abort a request or requests.
    ...
    def check_health(self) -> None:
        ...
        Raises:
            RuntimeError: If the engine is not healthy
        """
