...
class Scheduler:
    def initialize(self, od_config: OmniDiffusionConfig):
        ...
        # Lock to protect the enqueue -> dequeue critical section.
        # Without this, concurrent calls to add_req / collective_rpc can
        # steal each other's results from result_mq.
